    ...
    <>
      ...
      <div className="container-tweeters">
        <img
          ...
          onClick={() => handleImageClick("Andrew Huberman")}
        />
        <img
          src="./images/Feifei-Li.jpeg"
          alt="Picture of Fei Fei Li"
          onClick={() => handleImageClick("Fei Fei Li")}
        />
        <img
          src="./images/Elon-Musk.jpeg"
          alt="Picture of Elon Musk"
          onClick={() => handleImageClick("Elon Musk")}
        />
        <img
          src="./images/Gwynne-Shotwell.jpeg"
          alt="Picture of Gwynne Shotwell"
          onClick={() => handleImageClick("Gwynne Shotwell")}
        />
        <img
          src="./images/Jordan-Peterson.jpeg"
          alt="Picture of Jordan Peterson"
          onClick={() => handleImageClick("Jordan Peterson")}
        />
      </div>
    </>
  );
